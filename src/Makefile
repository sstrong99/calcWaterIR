...
OBJ_DIR = OBJ
SRCS  = main.cpp traj.cpp calcIR.cpp integrateF.cpp adamsBashforth.cpp exactDiag.cpp timer.cpp histogram.cpp calcDists.cpp calcW.cpp initTraj.cpp input.cpp calcIR_TAA.cpp calculation.cpp
